...
function sum(a, b) { //eslint-disable-line
    let p1 = a + b;
    let msg = 'The sum of '+ a +' and '+ b +' is '+ p1 +'.';
    return [p1, msg];
}
// console.log(sum(4, 7));
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    return [summation, product, msg1, msg2];
...
returns an array where the first element is the sum of the numbers in the array, and 
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    for (let i = 0; i < testArray.length; i++) {
        summation = sum(summation, sumArr[i])[0];
        
    }
    let msg = testArray.toString() +' was passed in as an array of numbers, and '+ summation +' is their sum.';
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    let msg = 'The numbers '+ testArray.toString() +' have a product of '+ multiplication +'.';
    return [multiplication, msg];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (let i = 0; i < testDynamicArray.length; i++) {
        multiplication = multiply(multiplication, dynamicArray[i])[0];
        
    }
    let msg = 'The numbers '+ testDynamicArray.toString() +' have a product of '+ multiplication +'.';
    return [multiplication, msg];
}
